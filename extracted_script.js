...
Mit freundlichen Grüßen`;
        ...
        function sendEmailFromPreview(toEmail, subject, encodedBody) {
            ...
            // Wenn Base64-Bild verfügbar, füge es als eingebettetes Bild hinzu
            if (window.flohmarktEmailImageBase64) {
                // Füge Bild als HTML-img mit Data-URL ein
                body += `\n\n---\n[Produktbild wird angehängt]`;
                // Base64-Bild wird in HTML-Format angehängt (viele Email-Clients unterstützen das)
            }
